...
contract PZS_Staking {
    ...
    address public stakingPooladmin = 0x7cC26960D2A47c659A8DBeCEb0937148b0026fD6 ;
    ...
    string public poolBatchType = 'Fixed';
    ...
    uint public poolExpirationPeriod = now + 50 minutes ;     //  place 30 days in final deployement
    uint public minimumStakingDuration = 10 minutes;          // place 5 hours in final deployment    
    ...
    mapping(address => uint) public expectedOctapayReceivedByAnAddressForActionsSaving ; 
...
//////////////////////////////////////////////////////////////////////////////////////Staking Function//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function startOctapayTokenMinting() public onlyAdmin {
     ...
     expectedOctapayReceivedByAnAddressForActionsSaving[recipient] =  expectedOctapayReceivedByAnAddress[recipient] ;
    ...
    function unstakeTokens() public {
        ...
        require((balance > 0 && now > poolExpirationPeriod) || (stopContract == true) , "staking balance cannot be 0 or you cannot stake before pool expiration period");
